...
for (let i = 0; i < countries_data.length; i++) {
    ...
    span.innerText =`Country = ${countries_data[i].name}, Popular Languages = ${countries_data[i].languages} \n`;
...
console.log(countries_data.reduce(sumPop));//Object Object çıktısı veriyor

const redDeneme = countries_data.reduce(function(acc, prev){
